...
func SettingsProjects(user *session.Session) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div x-data=\"projectsController()\" x-init=\"init()\" class=\"space-y-6\"><!-- Header --><div class=\"flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4\"><div><h1 class=\"text-2xl font-bold text-gray-900\">Projects</h1><p class=\"mt-1 text-sm text-gray-500\">Manage projects and team members</p></div><button @click=\"openCreate()\" class=\"inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 transition-colors\"><svg class=\"w-4 h-4 mr-2\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4v16m8-8H4\"></path></svg> Create Project</button></div><!-- Search --><div class=\"bg-white shadow rounded-lg p-4\"><div class=\"max-w-md\"><label class=\"label\">Search</label> <input type=\"text\" x-model=\"search\" @input.debounce.300ms=\"filterProjects()\" placeholder=\"Search projects...\" class=\"input-field\"></div></div><!-- Projects Table --><div class=\"bg-white shadow rounded-lg overflow-hidden\"><!-- Loading state --><div x-show=\"loading\" class=\"p-8 text-center\"><svg class=\"animate-spin h-8 w-8 mx-auto text-indigo-600\" fill=\"none\" viewBox=\"0 0 24 24\"><circle class=\"opacity-25\" cx=\"12\" cy=\"12\" r=\"10\" stroke=\"currentColor\" stroke-width=\"4\"></circle> <path class=\"opacity-75\" fill=\"currentColor\" d=\"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\"></path></svg><p class=\"mt-2 text-gray-500\">Loading projects...</p></div><!-- Empty state --><div x-show=\"!loading && filteredProjects.length === 0\" class=\"p-8 text-center\"><svg class=\"mx-auto h-12 w-12 text-gray-400\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z\"></path></svg><h3 class=\"mt-2 text-sm font-medium text-gray-900\">No projects found</h3><p class=\"mt-1 text-sm text-gray-500\">Get started by creating a new project.</p></div><!-- Table --><div x-show=\"!loading && filteredProjects.length > 0\" class=\"overflow-x-auto\"><table class=\"min-w-full divide-y divide-gray-200\"><thead class=\"bg-gray-50\"><tr><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Name</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Description</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Members</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Created</th><th class=\"px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider\">Actions</th></tr></thead> <tbody id=\"projects-tbody\" class=\"bg-white divide-y divide-gray-200\"><!-- Rows rendered by Alpine.js --></tbody></table></div></div><!-- Create/Edit Modal -->")
			if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = layouts.Base("Projects", user).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var8 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Var9 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<div class=\"space-y-4\"><!-- Members list --><div x-show=\"!loadingMembers && members.length > 0\" class=\"divide-y divide-gray-200\"><template x-for=\"member in members\" :key=\"member.user_id\"><div class=\"py-3 flex items-center justify-between\"><div class=\"flex items-center\"><div class=\"w-8 h-8 bg-indigo-600 rounded-full flex items-center justify-center flex-shrink-0\"><span class=\"text-white text-sm font-medium\" x-text=\"member.username.charAt(0).toUpperCase()\"></span></div><div class=\"ml-3\"><p class=\"text-sm font-medium text-gray-900\" x-text=\"member.username\"></p><p class=\"text-sm text-gray-500\" x-text=\"member.email\"></p></div></div><div class=\"flex items-center gap-2\"><span class=\"badge\" :class=\"member.role === 'admin' ? 'badge-indigo' : member.role === 'operator' ? 'badge-blue' : 'badge-gray'\" x-text=\"member.role\"></span> <button @click=\"removeMember(member.user_id)\" class=\"text-red-600 hover:text-red-900 text-sm\">Remove</button></div></div></template></div><!-- Empty members --><div x-show=\"!loadingMembers && members.length === 0\" class=\"text-center py-4 text-gray-500 text-sm\">No members yet</div><!-- Loading members --><div x-show=\"loadingMembers\" class=\"text-center py-4\"><svg class=\"animate-spin h-6 w-6 mx-auto text-indigo-600\" fill=\"none\" viewBox=\"0 0 24 24\"><circle class=\"opacity-25\" cx=\"12\" cy=\"12\" r=\"10\" stroke=\"currentColor\" stroke-width=\"4\"></circle> <path class=\"opacity-75\" fill=\"currentColor\" d=\"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z\"></path></svg></div><!-- Add member form --><div class=\"pt-4 border-t border-gray-200\"><h4 class=\"text-sm font-medium text-gray-900 mb-3\">Add Member</h4><div class=\"flex gap-2\"><select x-model=\"addMemberForm.user_id\" class=\"select-field flex-1\"><option value=\"\">Select user...</option><template x-for=\"u in availableUsers\" :key=\"u.id\"><option :value=\"u.id\" x-text=\"u.username + ' (' + u.email + ')'\"></option></template></select> <select x-model=\"addMemberForm.role\" class=\"select-field w-32\"><option value=\"viewer\">Viewer</option> <option value=\"operator\">Operator</option> <option value=\"admin\">Admin</option></select> <button @click=\"addMember()\" :disabled=\"!addMemberForm.user_id\" class=\"btn-primary w-auto px-4\">Add</button></div></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
		...
		templ_7745c5c3_Err = components.ModalWithFooter("showMembersModal", "'Members: ' + (selectedProject?.name || '')").Render(templ.WithChildren(ctx, templ_7745c5c3_Var8), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
