...
func SettingsConnections(user *session.Session, csrfToken string, cspNonce string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div x-data=\"connectionsController\" x-init=\"init()\" class=\"space-y-6\"><!-- Header --><div class=\"flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4\"><div><h1 class=\"page-title\">Connections</h1><p class=\"page-subtitle\">Manage SSH connections for log collection</p></div><button @click=\"openCreate()\" class=\"btn-primary w-auto\"><svg class=\"w-4 h-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4v16m8-8H4\"></path></svg> Create Connection</button></div><!-- Filters --><div class=\"panel-soft p-4\"><div class=\"flex flex-col sm:flex-row gap-4\"><div class=\"flex-1\"><label class=\"label\">Search</label> <input type=\"text\" x-model=\"search\" @input.debounce.300ms=\"filterConnections()\" placeholder=\"Search connections...\" class=\"input-field\"></div><div class=\"sm:w-48\"><label class=\"label\">Project</label> <select x-model=\"filterProject\" @change=\"loadConnections()\" class=\"select-field\"><option value=\"\">All Projects</option><template x-for=\"p in projects\" :key=\"p.id\"><option :value=\"p.id\" x-text=\"p.name\"></option></template></select></div><div class=\"sm:w-36\"><label class=\"label\">Status</label> <select x-model=\"filterStatus\" @change=\"filterConnections()\" class=\"select-field\"><option value=\"\">All Statuses</option> <option value=\"connected\">Connected</option> <option value=\"failed\">Failed</option> <option value=\"unknown\">Unknown</option></select></div></div></div><!-- Connections Table --><div class=\"table-shell overflow-hidden\"><!-- Loading state --><div x-show=\"loading\" class=\"p-8 text-center\"><svg class=\"animate-spin h-8 w-8 mx-auto text-teal-600\" fill=\"none\" viewBox=\"0 0 24 24\"><circle class=\"opacity-25\" cx=\"12\" cy=\"12\" r=\"10\" stroke=\"currentColor\" stroke-width=\"4\"></circle> <path class=\"opacity-75\" fill=\"currentColor\" d=\"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\"></path></svg><p class=\"mt-2 text-slate-500\">Loading connections...</p></div><!-- Empty state --><div x-show=\"!loading && filteredConnections.length === 0\" class=\"p-8 text-center\"><svg class=\"mx-auto h-12 w-12 text-slate-400\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01\"></path></svg><h3 class=\"mt-2 text-sm font-semibold text-slate-900\">No connections found</h3><p class=\"mt-1 text-sm text-slate-500\">Get started by creating a new SSH connection.</p></div><!-- Table --><div x-show=\"!loading && filteredConnections.length > 0\" class=\"overflow-x-auto\"><table class=\"min-w-full divide-y divide-slate-200/70\"><thead class=\"table-head\"><tr><th class=\"px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500\">Name</th><th class=\"px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500\">Type</th><th class=\"px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500\">Host</th><th class=\"px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500\">Status</th><th class=\"px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500\">Last Tested</th><th class=\"px-6 py-3 text-right text-xs font-semibold uppercase tracking-wider text-slate-500\">Actions</th></tr></thead> <tbody id=\"connections-tbody\" class=\"divide-y divide-slate-200/70\"><!-- Rows rendered by Alpine.js --></tbody></table></div></div><!-- Create/Edit Modal -->")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = ConnectionsScript(cspNonce).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = layouts.Base("Connections", user, csrfToken, cspNonce).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ConnectionsScript(cspNonce string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
