...
func SettingsUsers(user *session.Session) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div x-data=\"usersController()\" x-init=\"init()\" class=\"space-y-6\"><!-- Header --><div class=\"flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4\"><div><h1 class=\"text-2xl font-bold text-gray-900\">Users</h1><p class=\"mt-1 text-sm text-gray-500\">Manage user accounts and roles</p></div><button @click=\"openCreate()\" class=\"inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 transition-colors\"><svg class=\"w-4 h-4 mr-2\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4v16m8-8H4\"></path></svg> Create User</button></div><!-- Search --><div class=\"bg-white shadow rounded-lg p-4\"><div class=\"flex flex-col sm:flex-row gap-4\"><div class=\"flex-1\"><label class=\"label\">Search</label> <input type=\"text\" x-model=\"search\" @input.debounce.300ms=\"filterUsers()\" placeholder=\"Search by username or email...\" class=\"input-field\"></div><div class=\"sm:w-36\"><label class=\"label\">Role</label> <select x-model=\"filterRole\" @change=\"filterUsers()\" class=\"select-field\"><option value=\"\">All Roles</option> <option value=\"admin\">Admin</option> <option value=\"operator\">Operator</option> <option value=\"viewer\">Viewer</option></select></div></div></div><!-- Users Table --><div class=\"bg-white shadow rounded-lg overflow-hidden\"><!-- Loading state --><div x-show=\"loading\" class=\"p-8 text-center\"><svg class=\"animate-spin h-8 w-8 mx-auto text-indigo-600\" fill=\"none\" viewBox=\"0 0 24 24\"><circle class=\"opacity-25\" cx=\"12\" cy=\"12\" r=\"10\" stroke=\"currentColor\" stroke-width=\"4\"></circle> <path class=\"opacity-75\" fill=\"currentColor\" d=\"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\"></path></svg><p class=\"mt-2 text-gray-500\">Loading users...</p></div><!-- Empty state --><div x-show=\"!loading && filteredUsers.length === 0\" class=\"p-8 text-center\"><svg class=\"mx-auto h-12 w-12 text-gray-400\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z\"></path></svg><h3 class=\"mt-2 text-sm font-medium text-gray-900\">No users found</h3><p class=\"mt-1 text-sm text-gray-500\">Try adjusting your search filters.</p></div><!-- Table --><div x-show=\"!loading && filteredUsers.length > 0\" class=\"overflow-x-auto\"><table class=\"min-w-full divide-y divide-gray-200\"><thead class=\"bg-gray-50\"><tr><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">User</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Email</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Role</th><th class=\"px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider\">Created</th><th class=\"px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider\">Actions</th></tr></thead> <tbody id=\"users-tbody\" class=\"bg-white divide-y divide-gray-200\"><!-- Rows rendered by Alpine.js --></tbody></table></div></div><!-- Create User Modal -->")
			if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = layouts.Base("Users", user).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var8 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Var9 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<div class=\"space-y-4\"><!-- Username (read-only) --><div><label class=\"label\">Username</label> <input type=\"text\" :value=\"selectedUser?.username\" class=\"input-field bg-gray-100\" disabled></div><!-- Email --><div><label class=\"label\">Email <span class=\"text-red-500\">*</span></label> <input type=\"email\" x-model=\"editForm.email\" class=\"input-field\"></div><!-- Role --><div><label class=\"label\">Role <span class=\"text-red-500\">*</span></label> <select x-model=\"editForm.role\" class=\"select-field\"><option value=\"viewer\">Viewer - Read-only access</option> <option value=\"operator\">Operator - Can manage alerts</option> <option value=\"admin\">Admin - Full access</option></select><p x-show=\"selectedUser?.id === currentUserId\" class=\"mt-1 text-xs text-yellow-600\">Warning: Changing your own role may affect your access</p></div><!-- Error message --><div x-show=\"formError\" class=\"p-3 bg-red-50 text-red-700 rounded-md text-sm\" x-text=\"formError\"></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Var13 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<div class=\"space-y-4\"><p class=\"text-sm text-gray-600\">Reset password for <strong x-text=\"selectedUser?.username\"></strong></p><!-- New Password --><div><label class=\"label\">New Password <span class=\"text-red-500\">*</span></label> <input type=\"password\" x-model=\"passwordForm.password\" class=\"input-field\" placeholder=\"Min 8 characters\"><p class=\"mt-1 text-xs text-gray-500\">Uppercase, lowercase, number, and special character</p></div><!-- Confirm Password --><div><label class=\"label\">Confirm Password <span class=\"text-red-500\">*</span></label> <input type=\"password\" x-model=\"passwordForm.confirm\" class=\"input-field\" placeholder=\"Re-enter password\"></div><!-- Error message --><div x-show=\"formError\" class=\"p-3 bg-red-50 text-red-700 rounded-md text-sm\" x-text=\"formError\"></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
