...
func SettingsUsers(user *session.Session, csrfToken string, cspNonce string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = UsersScript(user.ID, cspNonce).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		})
		templ_7745c5c3_Err = layouts.Base("Users", user, csrfToken, cspNonce).Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func UserCreateModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<form @submit.prevent=\"createUser()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Var5 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<div class=\"space-y-4\"><!-- Username --><div><label for=\"create-user-username\" class=\"label\">Username <span class=\"text-red-500\">*</span></label> <input id=\"create-user-username\" name=\"create_user_username\" type=\"text\" autocomplete=\"username\" x-model=\"createForm.username\" class=\"input-field\" placeholder=\"johndoe\"><p class=\"mt-1 text-xs text-slate-500\">3-32 characters, letters, numbers, _ and -</p></div><!-- Email --><div><label for=\"create-user-email\" class=\"label\">Email <span class=\"text-red-500\">*</span></label> <input id=\"create-user-email\" name=\"create_user_email\" type=\"email\" autocomplete=\"email\" x-model=\"createForm.email\" class=\"input-field\" placeholder=\"john@example.com\"></div><!-- Password --><div><label for=\"create-user-password\" class=\"label\">Password <span class=\"text-red-500\">*</span></label> <input id=\"create-user-password\" name=\"create_user_password\" type=\"password\" autocomplete=\"new-password\" x-model=\"createForm.password\" class=\"input-field\" placeholder=\"Min 8 characters\"><p class=\"mt-1 text-xs text-slate-500\">Uppercase, lowercase, number, and special character</p></div><!-- Role --><div><label for=\"create-user-role\" class=\"label\">Role <span class=\"text-red-500\">*</span></label> <select id=\"create-user-role\" name=\"create_user_role\" x-model=\"createForm.role\" class=\"select-field\"><option value=\"viewer\">Viewer - Read-only access</option> <option value=\"operator\">Operator - Can manage alerts</option> <option value=\"admin\">Admin - Full access</option></select></div><!-- Error message --><div x-show=\"formError\" class=\"p-3 bg-rose-50 text-rose-700 rounded-md text-sm\" x-text=\"formError\"></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
			...
			templ_7745c5c3_Var6 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<button type=\"button\" @click=\"showCreateModal = false\" class=\"btn-secondary\">Cancel</button> <button type=\"submit\" :disabled=\"saving\" class=\"btn-primary w-auto\"><span x-show=\"!saving\">Create</span> <span x-show=\"saving\">Creating...</span></button>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
...
func UserEditModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var8 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "<form @submit.prevent=\"updateUser()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Var9 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<div class=\"space-y-4\"><!-- Username (read-only) --><div><label for=\"edit-user-username\" class=\"label\">Username</label> <input id=\"edit-user-username\" name=\"edit_user_username\" type=\"text\" :value=\"selectedUsername()\" class=\"input-field bg-slate-100\" disabled></div><!-- Email --><div><label for=\"edit-user-email\" class=\"label\">Email <span class=\"text-red-500\">*</span></label> <input id=\"edit-user-email\" name=\"edit_user_email\" type=\"email\" x-model=\"editForm.email\" class=\"input-field\"></div><!-- Role --><div><label for=\"edit-user-role\" class=\"label\">Role <span class=\"text-red-500\">*</span></label> <select id=\"edit-user-role\" name=\"edit_user_role\" x-model=\"editForm.role\" class=\"select-field\"><option value=\"viewer\">Viewer - Read-only access</option> <option value=\"operator\">Operator - Can manage alerts</option> <option value=\"admin\">Admin - Full access</option></select><p x-show=\"isSelectedCurrentUser()\" class=\"mt-1 text-xs text-amber-600\">Warning: Changing your own role may affect your access</p></div><!-- Error message --><div x-show=\"formError\" class=\"p-3 bg-rose-50 text-rose-700 rounded-md text-sm\" x-text=\"formError\"></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
			...
			templ_7745c5c3_Var10 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<button type=\"button\" @click=\"showEditModal = false\" class=\"btn-secondary\">Cancel</button> <button type=\"submit\" :disabled=\"saving\" class=\"btn-primary w-auto\"><span x-show=\"!saving\">Save</span> <span x-show=\"saving\">Saving...</span></button>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
...
func UserPasswordModal() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "<form @submit.prevent=\"resetPassword()\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Var13 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 15, "<div class=\"space-y-4\"><p class=\"text-sm text-slate-600\">Reset password for <strong x-text=\"selectedUsername()\"></strong></p><input type=\"text\" name=\"reset_user_username\" autocomplete=\"username\" :value=\"selectedUsername()\" class=\"sr-only\" tabindex=\"-1\" aria-hidden=\"true\"><!-- New Password --><div><label for=\"reset-user-password\" class=\"label\">New Password <span class=\"text-red-500\">*</span></label> <input id=\"reset-user-password\" name=\"reset_user_password\" type=\"password\" autocomplete=\"new-password\" x-model=\"passwordForm.password\" class=\"input-field\" placeholder=\"Min 8 characters\"><p class=\"mt-1 text-xs text-slate-500\">Uppercase, lowercase, number, and special character</p></div><!-- Confirm Password --><div><label for=\"reset-user-password-confirm\" class=\"label\">Confirm Password <span class=\"text-red-500\">*</span></label> <input id=\"reset-user-password-confirm\" name=\"reset_user_password_confirm\" type=\"password\" autocomplete=\"new-password\" x-model=\"passwordForm.confirm\" class=\"input-field\" placeholder=\"Re-enter password\"></div><!-- Error message --><div x-show=\"formError\" class=\"p-3 bg-rose-50 text-rose-700 rounded-md text-sm\" x-text=\"formError\"></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
			...
			templ_7745c5c3_Var14 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				ctx = templ.InitializeContext(ctx)
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 16, "<button type=\"button\" @click=\"showPasswordModal = false\" class=\"btn-secondary\">Cancel</button> <button type=\"submit\" :disabled=\"saving\" class=\"btn-primary w-auto\"><span x-show=\"!saving\">Reset Password</span> <span x-show=\"saving\">Resetting...</span></button>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				return nil
...
func UsersScript(currentUserID string, cspNonce string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context
		if templ_7745c5c3_CtxErr := ctx.Err(); templ_7745c5c3_CtxErr != nil {
			return templ_7745c5c3_CtxErr
		...
		templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(cspNonce)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/settings_users.templ`, Line: 325, Col: 25}
		}
		...
		templ_7745c5c3_Var17, templ_7745c5c3_Err := templruntime.ScriptContentInsideStringLiteral(currentUserID)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/pages/settings_users.templ`, Line: 333, Col: 36}
		}
